...
CONTAINS
   ...
   SUBROUTINE tra_mfc( kt, Kmm, pts, Krhs )
     ...
     !
      ...
      !-------------------------------------------
      zhcmo(:,:) = e3t_0(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),1)
      zfbuo(:,:)   = 0._wp
 ...
 CALL eos( pts (:,:,jk ,:,Kmm) , zrautb(:,:) )
         ...
         DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)
            zphm1(ji,jj)  = zphm1(ji,jj)  + grav * zrautbm1(ji,jj) * e3t_0(ji,jj,jk-1)
            zphpm1(ji,jj) = zphpm1(ji,jj) + grav * zraupl(ji,jj)   * e3t_0(ji,jj,jk-1)
            zph(ji,jj)    = zphm1(ji,jj)  + grav * zrautb(ji,jj)   * e3t_0(ji,jj,jk  )
         ...
         DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)
            ...
            zrw              =  (gdept_0(ji,jj,jk) - gdepw_0(ji,jj,jk)) &
            ...
            znum = 0.5_wp  + zcnh - &
                   ...
                   *e3t_0(ji,jj,jk-1)*0.5_wp   
            zden = 0.5_wp + zcnh + &
                   (zcnh*grav*zraupl(ji,jj)/zph(ji,jj)+zcb*zepsW(ji,jj,jk-1)) &
                   *e3t_0(ji,jj,jk-1)*0.5_wp   

            zcoef1 = zca*e3t_0(ji,jj,jk-1) / zden
            zcoef2 = znum/zden
            ...
            IF( rn_cap .GT. 0. ) THEN
               ...
               IF( zxw > 0. ) THEN
                  ...
                  zxl = (zrwp(ji,jj,jk-1)-zrwp(ji,jj,jk))/(e3t_0(ji,jj,jk-1)*zxw)
                  ...
                  END IF
                     ...
                     &                (1._wp + (zxl + zctre - zcdet )*e3t_0(ji,jj,jk-1))
                  ELSE
            ...
            zcoef1 =  (1._wp-zepsT(ji,jj,jk)*(1._wp-zrw)*e3w_0(ji,jj,jk)*wmask(ji,jj,jk ) ) &
            &       / (1._wp+zepsT(ji,jj,jk)*zrw*e3w_0(ji,jj,jk)*wmask(ji,jj,jk) )
            !
            zcoef2 =  zepsT(ji,jj,jk)*e3w_0(ji,jj,jk)*wmask(ji,jj,jk)                       &
            &       / (1._wp+zepsT(ji,jj,jk)*zrw*e3w_0(ji,jj,jk)*wmask(ji,jj,jk))
            !
      ...
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)
         edmfa(ji,jj,jk) =  0._wp
         edmfb(ji,jj,jk) = -edmfm(ji,jj,jk  ) / e3w_0(ji,jj,jk+1)
         edmfc(ji,jj,jk) =  edmfm(ji,jj,jk+1) / e3w_0(ji,jj,jk+1)
      END DO   ;   END DO   ;   END DO
      DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)
         edmfa(ji,jj,jpk)   = -edmfm(ji,jj,jpk-1) / e3w_0(ji,jj,jpk)
         edmfb(ji,jj,jpk)   =  edmfm(ji,jj,jpk  ) / e3w_0(ji,jj,jpk)
      ...
      !---------------------------------------------------------------
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)
        edmftra(ji,jj,jk,1) = - edmfm(ji,jj,jk  ) * ztsp(ji,jj,jk  ,jp_tem) / e3w_0(ji,jj,jk+1) &
                            & + edmfm(ji,jj,jk+1) * ztsp(ji,jj,jk+1,jp_tem) / e3w_0(ji,jj,jk+1)
      END DO   ;   END DO   ;   END DO
      DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)
         edmftra(ji,jj,jpk,1) = - edmfm(ji,jj,jpk-1) * ztsp(ji,jj,jpk-1,jp_tem) / e3w_0(ji,jj,jpk) &
                              & + edmfm(ji,jj,jpk  ) * ztsp(ji,jj,jpk  ,jp_tem) / e3w_0(ji,jj,jpk)
      END DO   ;   END DO
      ...
      !---------------------------------------------------------------
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)
         edmftra(ji,jj,jk,2) =  - edmfm(ji,jj,jk  ) * ztsp(ji,jj,jk  ,jp_sal) / e3w_0(ji,jj,jk+1) &
                             &  + edmfm(ji,jj,jk+1) * ztsp(ji,jj,jk+1,jp_sal) / e3w_0(ji,jj,jk+1)
      END DO   ;   END DO   ;   END DO
      DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)
         edmftra(ji,jj,jpk,2) = - edmfm(ji,jj,jpk-1) * ztsp(ji,jj,jpk-1,jp_sal) / e3w_0(ji,jj,jpk) &
                              & + edmfm(ji,jj,jpk  ) * ztsp(ji,jj,jpk  ,jp_sal) / e3w_0(ji,jj,jpk)
      END DO   ;   END DO
      !
   ...
   SUBROUTINE diag_mfc( zdiagi, zdiagd, zdiags, p2dt, Kaa )
      ...
      INTEGER  ::   ji, jj, jk  ! dummy  loop arguments   
         ...
         DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)
            zdiagi(ji,jj,jk) = zdiagi(ji,jj,jk) + e3t_0(ji,jj,jk) * p2dt *edmfa(ji,jj,jk)
            zdiags(ji,jj,jk) = zdiags(ji,jj,jk) + e3t_0(ji,jj,jk) * p2dt *edmfc(ji,jj,jk)
            zdiagd(ji,jj,jk) = zdiagd(ji,jj,jk) + e3t_0(ji,jj,jk) * p2dt *edmfb(ji,jj,jk)
         END DO   ;   END DO   ;   END DO
