...
CONTAINS
   ...
   SUBROUTINE usrdef_sbc_oce( kt, Kbb )
      ...
      DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)   ! emp and rnf used in sshwzv over the whole domain
      ...
      DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)   ! emp used in sshwzv over the whole domain
