...
CONTAINS
   ...
   SUBROUTINE zdf_osm( kt, Kbb, Kmm, Krhs, p_avm,   &
      ...
      ! ##########################################################################
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         hbl(ji,jj) = MAX(hbl(ji,jj), gdepw_0(ji,jj,4) )
      END DO   ;   END DO
      DO jj = ntsj-(  nn_hls-( nn_hls+ nn_hls )*nthb), ntej+(  nn_hls -( nn_hls + nn_hls)*ntht) ; DO ji = ntsi-( nn_hls-( nn_hls+ nn_hls)*nthl), ntei+(  nn_hls-( nn_hls+ nn_hls)*nthr)
         nbld(ji,jj) = 4
      END DO   ;   END DO
      DO jk =  5,  jpkm1  ; DO jj = ntsj-(   nn_hls-(  nn_hls+  nn_hls)*nthb), ntej+(   nn_hls-(  nn_hls+  nn_hls)*ntht) ; DO ji = ntsi-( nn_hls-( nn_hls+  nn_hls)*nthl), ntei+(   nn_hls-(  nn_hls+ nn_hls)*nthr)
         IF ( MAX( hbl(ji,jj), gdepw_0(ji,jj,4) ) >= gdepw_0(ji,jj,jk) ) THEN
      ...
      !
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         zhbl(ji,jj) = gdepw_0(ji,jj,nbld(ji,jj))
         nmld(ji,jj) = MAX( 3, nbld(ji,jj) - MAX( INT( dh(ji,jj) / e3t_0(ji,jj,nbld(ji,jj)-1) ), 1 ) )
         zhml(ji,jj) = gdepw_0(ji,jj,nmld(ji,jj))
      ...
      IF ( ln_osm_mle ) THEN
         ...
         DO jk =  5,  jpkm1  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
            IF ( hmle(ji,jj) >= gdepw_0(ji,jj,jk) ) mld_prof(ji,jj) = MIN( mbkt(ji,jj), jk)
         END DO   ;   END DO   ;   END DO
         ...
         !
         DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
            zhmle(ji,jj) = gdepw_0(ji,jj,mld_prof(ji,jj))
         END DO   ;   END DO
         !
      ...
      !            ztmp = 0.2 * zhbl(ji,jj) / e3w_0(ji,jj,nbld(ji,jj))
      !            IF ( ztmp > 6 ) THEN
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         ...
         IF ( mbkt(ji,jj) > 2 ) THEN   ! To ensure mbkt(ji,jj) - 2 > 0 so no incorrect array access
            IF ( zhbl_t(ji,jj) > gdepw_0(ji, jj,mbkt(ji,jj)-2) ) THEN
               zhbl_t(ji,jj) = MIN( zhbl_t(ji,jj), gdepw_0(ji,jj,mbkt(ji,jj)-2) )   ! ht_0(:,:))
               l_pyc(ji,jj)  = .FALSE.
      ...
      DO jk =  4,  jpkm1  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
         IF ( zhbl_t(ji,jj) >= gdepw_0(ji,jj,jk) ) THEN
            nbld(ji,jj) = jk
         END IF
      END DO   ;   END DO   ;   END DO
      !
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         IF ( av_db_bl(ji,jj) < rn_osm_bl_thresh .OR. nbld(ji,jj) >= mbkt(ji,jj) - 2 .OR.   &
            ...
            IF ( nbld(ji,jj) >= mbkt(ji,jj) -2 ) THEN
               ...
               zdh(ji,jj)  = gdepw_0(ji,jj,nbld(ji,jj)) - gdepw_0(ji,jj,nmld(ji,jj))   ! ag 19/03
               zhml(ji,jj) = gdepw_0(ji,jj,nmld(ji,jj))                                  ! ag 19/03
         ...
         DO jk = jkflt+1, jpkm1
            ...
            DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1)
               z2du(ji,jj) = 0.5_wp * ( uu(ji,jj,jk-1,Kmm) - uu(ji,jj,jk,Kmm) ) * ( uu(ji,jj,jk-1,Kbb) - uu(ji,jj,jk,Kbb) ) *   &
                  &          wumask(ji,jj,jk) / ( e3uw_0(ji,jj,jk) * e3uw_0(ji,jj,jk) )
               z2dv(ji,jj) = 0.5_wp * ( vv(ji,jj,jk-1,Kmm) - vv(ji,jj,jk,Kmm) ) * ( vv(ji,jj,jk-1,Kbb) - vv(ji,jj,jk,Kbb) ) *   &
                  &          wvmask(ji,jj,jk) / ( e3vw_0(ji,jj,jk) * e3vw_0(ji,jj,jk) )
            END DO   ;   END DO
            DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
      ...
      IF ( ln_osm_mle ) THEN   ! Set up diffusivity and non-gradient mixing
         DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
            IF ( l_flux(ji,jj) ) THEN   ! MLE mixing extends below boundary layer
               ...
               DO jk = 1, nbld(ji,jj)
                  znd = gdepw_0(ji,jj,jk) / MAX( zhbl(ji,jj), epsln )
               ...
               DO jk = 1, mld_prof(ji,jj)
                  znd = gdepw_0(ji,jj,jk) / MAX( zhmle(ji,jj), epsln )
                  ghamt(ji,jj,jk) = ghamt(ji,jj,jk) + ( swth0(ji,jj) - zrad0(ji,jj) + zradh(ji,jj) ) * ( 1.0_wp - znd )
                  ghams(ji,jj,jk) = ghams(ji,jj,jk) + sws0(ji,jj) * ( 1.0_wp -znd )
               END DO
               ! Viscosity for MLEs
               DO jk = 1, mld_prof(ji,jj)
                  znd = -1.0_wp * gdepw_0(ji,jj,jk) / MAX( zhmle(ji,jj), epsln )
   ...
   SUBROUTINE zdf_osm_vertical_average( Kbb, Kmm, knlev, pt, ps,   &
      ...
      DO jk =  2,  jkflt  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)   ! Upper, flat part of layer
         zthick(ji,jj) = zthick(ji,jj) + e3t_0(ji,jj,jk)
         pt(ji,jj)     = pt(ji,jj)     + e3t_0(ji,jj,jk) * ts(ji,jj,jk,jp_tem,Kmm)
         ps(ji,jj)     = ps(ji,jj)     + e3t_0(ji,jj,jk) * ts(ji,jj,jk,jp_sal,Kmm)
         pu(ji,jj)     = pu(ji,jj)     + e3t_0(ji,jj,jk) *                                        &
            &                               ( uu(ji,jj,jk,Kbb) + uu(ji - 1,jj,jk,Kbb) ) /           &
            &                               MAX( 1.0_wp , umask(ji,jj,jk) + umask(ji - 1,jj,jk) )
         pv(ji,jj)     = pv(ji,jj)     + e3t_0(ji,jj,jk) *                                        &
            ...
            IF ( av_db_bl(ji,jj) > 0.0_wp ) THEN
               ...
               IF ( pshear(ji,jj) > 1e-10 ) THEN
                  IF ( zri_p(ji,jj) < pp_ri_p_thresh .AND.   &
                     & MIN( hu_0(ji,jj), hu_0(ji-1,jj), hv_0(ji,jj), hv_0(ji,jj-1) ) > 100.0_wp ) THEN
                     ! Growing shear layer
                     n_ddh(ji,jj) = 0
                     l_shear(ji,jj) = .TRUE.
                  ELSE
   ...
   SUBROUTINE zdf_osm_external_gradients( Kmm, kbase, pdtdz, pdsdz, pdbdz )
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         IF ( kbase(ji,jj)+1 < mbkt(ji,jj) ) THEN
            ...
            pdtdz(ji,jj) = -1.0_wp * ( ts(ji,jj,jkb1,jp_tem,Kmm) - ts(ji,jj,jkb,jp_tem,Kmm ) ) / e3w_0(ji,jj,jkb1)
            pdsdz(ji,jj) = -1.0_wp * ( ts(ji,jj,jkb1,jp_sal,Kmm) - ts(ji,jj,jkb,jp_sal,Kmm ) ) / e3w_0(ji,jj,jkb1)
               ...
               DO jk = nmld(ji,jj), nbld(ji,jj)
                  ...
                  IF ( ln_osm_mle ) THEN
                     zhbl_s = zhbl_s + MIN( rn_Dt * ( ( -1.0_wp * pwb_ent(ji,jj) - 2.0_wp * pwb_fk_b(ji,jj) ) / zdb ) /   &
                        &                   REAL( nbld(ji,jj) - nmld(ji,jj), KIND=wp ), e3w_0(ji,jj,jm) )
                  ELSE
                     zhbl_s = zhbl_s + MIN( rn_Dt * ( -1.0_wp * pwb_ent(ji,jj) / zdb ) /   &
                        &                   REAL( nbld(ji,jj) - nmld(ji,jj), KIND=wp ), e3w_0(ji,jj,jm) )
                  ENDIF
                  !                    zhbl_s = MIN(zhbl_s,  gdepw_0(ji,jj, mbkt(ji,jj) + 1) - depth_tol)
                  IF ( zhbl_s >= gdepw_0(ji,jj,mbkt(ji,jj) + 1) ) THEN
                     zhbl_s = MIN( zhbl_s, gdepw_0(ji,jj, mbkt(ji,jj) + 1) - depth_tol )
                     l_pyc(ji,jj) = .FALSE.
                  ENDIF
                  IF ( zhbl_s >= gdepw_0(ji,jj,jm+1) ) jm = jm + 1
               END DO
               hbl(ji,jj)  = zhbl_s
               nbld(ji,jj) = jm
            ELSE   ! Stable
               DO jk = nmld(ji,jj), nbld(ji,jj)
                  ...
                  IF ( zhbl_s >= gdepw_0(ji,jj,mbkt(ji,jj) + 1) ) THEN
                     ...
                     l_pyc(ji,jj) = .FALSE.
                  ENDIF
                  IF ( zhbl_s >= gdepw_0(ji,jj,jm) ) jm = jm + 1
               END DO
            ENDIF   ! IF ( l_conv )
            hbl(ji,jj)  = MAX( zhbl_s, gdepw_0(ji,jj,4) )
            nbld(ji,jj) = MAX( jm, 4 )
         ELSE
            ! change zero or one model level.
            hbl(ji,jj) = MAX( phbl_t(ji,jj), gdepw_0(ji,jj,4) )
         ENDIF
         phbl(ji,jj) = gdepw_0(ji,jj,nbld(ji,jj))
      END DO   ;   END DO
      !
   ...
   SUBROUTINE zdf_osm_pycnocline_thickness( Kmm, pdh, phml, pdhdt, phbl,   &
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         ...
         inhml       = MAX( INT( dh(ji,jj) / MAX( e3t_0(ji,jj,nbld(ji,jj)-1), 1e-3_wp ) ), 1 )
         nmld(ji,jj) = MAX( nbld(ji,jj) - inhml, 3 )
         phml(ji,jj) = gdepw_0(ji,jj,nmld(ji,jj))
         ...
         IF ( nbld(ji,jj) + kp_ext(ji,jj) < mbkt(ji,jj) ) THEN
            ...
            IF ( l_conv(ji,jj) ) THEN   ! Convective conditions
               ...
               IF ( l_pyc(ji,jj) ) THEN
                  ...
                  DO jk = 2, nbld(ji,jj)
                     znd = -1.0_wp * ( gdepw_0(ji,jj,jk) - phbl(ji,jj) ) * ztmp
                     IF ( znd <= zzeta_m ) THEN
               ...
               IF ( pdhdt(ji,jj) > 0.0_wp ) THEN   ! Depth increasing, or steady.
                  IF ( av_db_bl(ji,jj) > 0.0_wp ) THEN
                     ...
                     ELSE   ! Slightly stable - 'thin' pycnoline - needed when stable layer begins to form.
                        ...
                        zbgrad = av_db_bl(ji,jj) * ztmp
                        DO jk = 2, nbld(ji,jj)
                           znd = -1.0_wp * ( gdepw_0(ji,jj,jk) - phml(ji,jj) ) * ztmp
         ...
         IF ( l_conv(ji,jj) ) THEN
            ...
            ELSE
               ...
               IF(l_coup(ji,jj) ) THEN   ! ag 19/03
                  ...
                  zz_b = -1.0_wp * gdepw_0(ji,jj,mbkt(ji,jj)+1)   ! ag 19/03
                  zc_coup_vis(ji,jj) = -0.5_wp * ( 0.5_wp * zvisml_sc(ji,jj) / phml(ji,jj) - zb_coup(ji,jj) ) /   &
                     &                 ( phml(ji,jj) + zz_b )   ! ag 19/03
                  zz_b = -1.0_wp * phml(ji,jj) + gdepw_0(ji,jj,mbkt(ji,jj)+1)   ! ag 19/03
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         IF ( l_conv(ji,jj) ) THEN
            DO jk = 2, nmld(ji,jj)   ! Mixed layer diffusivity
               zznd_ml = gdepw_0(ji,jj,jk) / phml(ji,jj)
            ...
            IF ( l_coup(ji,jj) ) THEN                                                         ! ag 19/03
               DO jk = mbkt(ji,jj), nmld(ji,jj), -1                                           ! ag 19/03
                  zz_b = -1.0_wp * ( gdepw_0(ji,jj,jk) - gdepw_0(ji,jj,mbkt(ji,jj)+1) )   ! ag 19/03
            ...
            IF ( l_pyc(ji,jj) ) THEN 
               ...
               DO jk = nmld(ji,jj) , nbld(ji,jj)
                  zznd_pyc = -1.0_wp * ( gdepw_0(ji,jj,jk) - phbl(ji,jj) ) / MAX(pdh(ji,jj), 1.0e-6_wp )
   ...
   !                     zdiffut(ji,jj,nbld(ji,jj)+1) = MAX( 0.5 * pdhdt(ji,jj) * e3w_0(ji,jj,nbld(ji,jj)+1), 1.0e-6 )
   !                     zviscos(ji,jj,nbld(ji,jj)+1) = MAX( 0.5 * pdhdt(ji,jj) * e3w_0(ji,jj,nbld(ji,jj)+1), 1.0e-6 )
   !                  ELSE
   ...
   !                  ENDIF
         ...
         ELSE
            ! Stable conditions
            DO jk = 2, nbld(ji,jj)
               zznd_ml = gdepw_0(ji,jj,jk) / phbl(ji,jj)
            ...
            !
            IF ( pdhdt(ji,jj) > 0.0_wp ) THEN
               pdiffut(ji,jj,nbld(ji,jj)) = MAX( pdhdt(ji,jj), 1.0e-6_wp) * e3w_0(ji, jj, nbld(ji,jj))
   ...
   SUBROUTINE zdf_osm_fgr_terms( Kmm, kp_ext, phbl, phml, pdh,                              &
      ...
      DO jk =  2,  MAX( jkm_mld, jkm_bld )  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
         IF ( l_conv(ji,jj) ) THEN
            IF ( jk <= nmld(ji,jj) ) THEN
               zznd_d = gdepw_0(ji,jj,jk) / dstokes(ji,jj)
      ...
      DO jk =  2,  jkm_bld  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
         IF ( l_conv(ji,jj) .AND. l_pyc(ji,jj) .AND. ( jk <= nbld(ji,jj) ) ) THEN
            zznd_pyc = -1.0_wp * ( gdepw_0(ji,jj,jk) - phbl(ji,jj) ) / pdh(ji,jj)
         ...
         ELSE
            IF( pdhdt(ji,jj) > 0. ) THEN
               IF ( ( jk > 1 ) .AND. ( jk <= nbld(ji,jj) ) ) THEN
                  zznd_d = gdepw_0(ji,jj,jk) / dstokes(ji,jj)
                  znd    = gdepw_0(ji,jj,jk) / phbl(ji,jj)
      ...
      DO jk =  2,  jkm_bld  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
         IF ( ( .NOT. l_conv(ji,jj) ) .AND. ( jk <= nbld(ji,jj) ) ) THEN
            znd = -1.0_wp * ( gdepw_0(ji,jj,jk) - phbl(ji,jj) ) / phbl(ji,jj)   ! ALMG to think about
            IF ( znd >= 0.0_wp ) THEN
      ...
      DO jk =  2,  jkm_bld  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
         IF ( l_conv (ji,jj) ) THEN
            ...
            !                     znd = -( gdepw_0(ji,jj,jk) - zhbl(ji,jj) ) / (zdh(ji,jj) + epsln ) - zzeta_v
            !                     IF ( znd <= 0.0 ) THEN
   ...
   SUBROUTINE zdf_osm_zmld_horizontal_gradients( Kmm, pmld, pdtdx, pdtdy, pdsdx,   &
      ...
      DO jk =  nlb10,  jpkm1  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls)
         ikt = mbkt(ji,jj)
         pmld(ji,jj) = pmld(ji,jj) + MAX( rn2b(ji,jj,jk), 0.0_wp ) * e3w_0(ji,jj,jk)
      ...
      DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)
         ...
         pmld(ji,jj)     = gdepw_0(ji,jj,jk_mld_prof(ji,jj))
      END DO   ;   END DO
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
      ...
      DO jk =  1,  ikmax  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls)
         zc = e3t_0(ji,jj,jk) * REAL( MIN( MAX( 0, jk_mld_prof(ji,jj) - jk ), 1  ), KIND=wp )   ! zc being 0 outside the ML
         !                                                                                        !    t-points
      ...
      DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)
         ztm(ji,jj) = ztm(ji,jj) / MAX( e3t_0(ji,jj,1), pmld(ji,jj) )
         zsm(ji,jj) = zsm(ji,jj) / MAX( e3t_0(ji,jj,1), pmld(ji,jj) )
      END DO   ;   END DO
         ...
         IF ( l_conv(ji,jj) ) THEN
            IF ( phmle(ji,jj) > 1.2_wp * phbl(ji,jj) ) THEN
               ...
               DO jk = nbld(ji,jj), mld_prof(ji,jj)
                  ...
                  zpe_mle_layer = zpe_mle_layer + zbuoy * gdepw_0(ji,jj,jk) * e3w_0(ji,jj,jk)
                  zpe_mle_ref   = zpe_mle_ref   + ( av_b_bl(ji,jj) - zdbdz_mle_int * ( gdepw_0(ji,jj,jk) - phbl(ji,jj) ) ) *   &
                     &                            gdepw_0(ji,jj,jk) * e3w_0(ji,jj,jk)
               END DO
   ...
   SUBROUTINE zdf_osm_mle_parameters( Kmm, pmld, phmle, pvel_mle, pdiff_mle,   &
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         ...
         ELSE
            ...
            END IF
         END IF
         hmle(ji,jj) = MAX( MIN( hmle(ji,jj), ht_0(ji,jj) ), gdepw_0(ji,jj,4) )
      ...
      END DO   ;   END DO   ;   END DO
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         phmle(ji,jj) = gdepw_0(ji,jj,mld_prof(ji,jj))
      END DO   ;   END DO
      !
...
904      IF( ios >  0 ) CALL ctl_nam( ios, 'namosm_mle in configuration namelist' )
   ...
   SUBROUTINE osm_rst( kt, Kmm, cdrw )
      ...
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls)
         ikt = mbkt(ji,jj)
         hbl(ji,jj) = hbl(ji,jj) + MAX( rn2(ji,jj,jk) , 0.0_wp ) * e3w_0(ji,jj,jk)
         IF ( hbl(ji,jj) < zN2_c ) imld_rst(ji,jj) = MIN( jk , ikt ) + 1   ! Mixed layer level
      END DO   ;   END DO   ;   END DO
      !
      DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)
         iiki = MAX( 4, imld_rst(ji,jj) )
         hbl(ji,jj) = gdepw_0(ji,jj,iiki)   ! Turbocline depth
         dh(ji,jj)  = e3t_0(ji,jj,iiki-1)   ! Turbocline depth
         hml(ji,jj) = hbl(ji,jj) - dh(ji,jj)
      END DO   ;   END DO
      !
   ...
   SUBROUTINE tra_osm( kt, Kmm, pts, Krhs )
      ...
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)
         pts(ji,jj,jk,jp_tem,Krhs) =  pts(ji,jj,jk,jp_tem,Krhs)                      &
            &                 - (  ghamt(ji,jj,jk  )  &
            &                    - ghamt(ji,jj,jk+1) ) /e3t_0(ji,jj,jk)
         pts(ji,jj,jk,jp_sal,Krhs) =  pts(ji,jj,jk,jp_sal,Krhs)                      &
            &                 - (  ghams(ji,jj,jk  )  &
            &                    - ghams(ji,jj,jk+1) ) / e3t_0(ji,jj,jk)
      END DO   ;   END DO   ;   END DO
      !
   ...
   SUBROUTINE dyn_osm( kt, Kmm, puu, pvv, Krhs )
      ...
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)   ! Add non-local u and v fluxes
         puu(ji,jj,jk,Krhs) =  puu(ji,jj,jk,Krhs) - ( ghamu(ji,jj,jk  ) -   &
            &                                         ghamu(ji,jj,jk+1) ) / e3u_0(ji,jj,jk)
         pvv(ji,jj,jk,Krhs) =  pvv(ji,jj,jk,Krhs) - ( ghamv(ji,jj,jk  ) -   &
            &                                         ghamv(ji,jj,jk+1) ) / e3v_0(ji,jj,jk)
      END DO   ;   END DO   ;   END DO
      !
