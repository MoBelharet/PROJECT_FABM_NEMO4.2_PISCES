...
CONTAINS
   ...
   SUBROUTINE ldf_c1d( cd_type, pahs1, pahs2, pah1, pah2 )
      ...
      CASE( 'DYN' )                     ! T- and F-points
         ...
         END DO
         DO jk =  jpkm1,  1,  -1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)  ! pah2 at F-point (zdep2 is an approximation in zps-coord.)
      ...
      CASE( 'TRA' )                     ! U- and V-points (zdep1 & 2 are an approximation in zps-coord.)
         DO jk =  jpkm1,  1,  -1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)
