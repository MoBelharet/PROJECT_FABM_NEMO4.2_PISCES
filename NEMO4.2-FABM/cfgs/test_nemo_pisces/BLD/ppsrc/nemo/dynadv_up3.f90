   ...
   SUBROUTINE dyn_adv_up3( kt, Kbb, Kmm, puu, pvv, Krhs )
      ...
      DO jk = 1, jpkm1                       !  Laplacian of the velocity  !
         ...
         DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)
            zfu(ji,jj,jk) = e2u(ji,jj) * e3u_0(ji,jj,jk) * puu(ji,jj,jk,Kmm)
            zfv(ji,jj,jk) = e1v(ji,jj) * e3v_0(ji,jj,jk) * pvv(ji,jj,jk,Kmm)
         END DO   ;   END DO
         !            
      ...
      DO jk = 1, jpk-2                    != divergence of advective fluxes =! (jk = 1 to jpk-2)
         ...
         DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)
            ...
            puu(ji,jj,jk,Krhs) = puu(ji,jj,jk,Krhs) - ( zfu_uw(ji,jj) - zzfu_uw_kp1 ) * r1_e1e2u(ji,jj) / e3u_0(ji,jj,jk)
            pvv(ji,jj,jk,Krhs) = pvv(ji,jj,jk,Krhs) - ( zfv_vw(ji,jj) - zzfv_vw_kp1 ) * r1_e1e2v(ji,jj) / e3v_0(ji,jj,jk)
      ...
      DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)
         puu(ji,jj,jk,Krhs) = puu(ji,jj,jk,Krhs) - zfu_uw(ji,jj) * r1_e1e2u(ji,jj) / e3u_0(ji,jj,jk)
         pvv(ji,jj,jk,Krhs) = pvv(ji,jj,jk,Krhs) - zfv_vw(ji,jj) * r1_e1e2v(ji,jj) / e3v_0(ji,jj,jk)
      END DO   ;   END DO
      !
