...
CONTAINS
   ...
   SUBROUTINE trc_adv( kt, Kbb, Kmm, ptr, Krhs  )
      ...
      !                                         !==  effective transport  ==!
      IF( l_offline ) THEN
         DO jk =  1,  jpk  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls-1)
      ...
      ELSE                                         ! build the effective transport
         ...
         IF( ln_wave .AND. ln_sdw )  THEN
            DO jk =  1,  jpkm1  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls-1)                            ! eulerian transport + Stokes Drift
               zuu(ji,jj,jk) = e2u  (ji,jj) * e3u_0(ji,jj,jk) * ( uu(ji,jj,jk,Kmm) + usd(ji,jj,jk) )
               zvv(ji,jj,jk) = e1v  (ji,jj) * e3v_0(ji,jj,jk) * ( vv(ji,jj,jk,Kmm) + vsd(ji,jj,jk) )
            END DO   ;   END DO   ;   END DO
         ...
         ELSE
            DO jk =  1,  jpkm1  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls-1)
               zuu(ji,jj,jk) = e2u  (ji,jj) * e3u_0(ji,jj,jk) * uu(ji,jj,jk,Kmm)           ! eulerian transport
               zvv(ji,jj,jk) = e1v  (ji,jj) * e3v_0(ji,jj,jk) * vv(ji,jj,jk,Kmm)
            END DO   ;   END DO   ;   END DO
            DO jk =  1,  jpkm1  ; DO jj = ntsj-(  nn_hls-1), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls-1), ntei+(  nn_hls-1)
