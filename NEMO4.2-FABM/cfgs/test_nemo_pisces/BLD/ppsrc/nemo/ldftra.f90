   ...
   SUBROUTINE ldf_eiv( kt, paei0, paeiu, paeiv, Kmm )
      ...
      IF( ln_traldf_triad ) THEN
         DO jk =  1,  jpk  ; DO jj = ntsj-(  nn_hls-1), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls-1), ntei+(  nn_hls-1)
            ...
            ze3w = e3w_0(ji,jj,jk) * wmask(ji,jj,jk)
...
!!gm      CALL iom_put( "psi_eiv_vw", psi_vw )
      ...
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)                                  ! e2u e3u u_eiv = -dk[psi_uw]
         zw3d(ji,jj,jk) = ( psi_uw(ji,jj,jk+1) - psi_uw(ji,jj,jk) ) / ( e2u(ji,jj) * e3u_0(ji,jj,jk) )
      END DO   ;   END DO   ;   END DO
      CALL iom_put( "uoce_eiv", zw3d )
      !
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)                                  ! e1v e3v v_eiv = -dk[psi_vw]
         zw3d(ji,jj,jk) = ( psi_vw(ji,jj,jk+1) - psi_vw(ji,jj,jk) ) / ( e1v(ji,jj) * e3v_0(ji,jj,jk) )
      END DO   ;   END DO   ;   END DO
