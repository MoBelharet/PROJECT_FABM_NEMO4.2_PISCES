...
CONTAINS
   ...
   SUBROUTINE prt_ctl_t (tab2d_1, ktab2d_1, tab3d_1, ktab3d_1, tab4d_1, ktab4d_1, tab2d_2, ktab2d_2, tab3d_2, ktab3d_2,  &
      ...
      REAL(dp),         DIMENSION((ntsi-nn_hls-1)*ktab2d_1+1:,(ntsj-nn_hls-1)*ktab2d_1+1:)    , INTENT(in), OPTIONAL ::   tab2d_1
      REAL(dp),         DIMENSION((ntsi-nn_hls-1)*ktab3d_1+1:,(ntsj-nn_hls-1)*ktab3d_1+1:,:)  , INTENT(in), OPTIONAL ::   tab3d_1
      REAL(dp),         DIMENSION((ntsi-nn_hls-1)*ktab4d_1+1:,(ntsj-nn_hls-1)*ktab4d_1+1:,:,:), INTENT(in), OPTIONAL ::   tab4d_1
      REAL(dp),         DIMENSION((ntsi-nn_hls-1)*ktab2d_2+1:,(ntsj-nn_hls-1)*ktab2d_2+1:)    , INTENT(in), OPTIONAL ::   tab2d_2
      REAL(dp),         DIMENSION((ntsi-nn_hls-1)*ktab3d_2+1:,(ntsj-nn_hls-1)*ktab3d_2+1:,:)  , INTENT(in), OPTIONAL ::   tab3d_2
      REAL(wp),           DIMENSION(:,:,:)  , INTENT(in), OPTIONAL ::   mask1
      REAL(wp),           DIMENSION(:,:,:)  , INTENT(in), OPTIONAL ::   mask2
      CHARACTER(len=*), DIMENSION(:)      , INTENT(in), OPTIONAL ::   clinfo    ! information about the tab3d array
      CHARACTER(len=*)                    , INTENT(in), OPTIONAL ::   clinfo1
