      ...
      DO jn = 1, kjpt                                            ! tracer loop
         ...
         DO jk = 1, jpkm1                                 ! Horizontal slab
            ...
            DO jj = ntsj-( iij), ntej+( iij-1 ) ; DO ji = ntsi-( iij), ntei+( iij-1)           !==  Horizontal fluxes
               zabe1 = pahu(ji,jj,jk) * e2_e1u(ji,jj) * e3u_0(ji,jj,jk)
               zabe2 = pahv(ji,jj,jk) * e1_e2v(ji,jj) * e3v_0(ji,jj,jk)
               !
         ...
         IF( ln_traldf_lap ) THEN               ! laplacian case: eddy coef = ah_wslp2 - akz
            DO jk =  2,  jpkm1  ; DO jj = ntsj-(  iij-1), ntej+(  iij-1) ; DO ji = ntsi-( iij-1), ntei+(  iij-1)
               ztfw(ji,jj,jk) = ztfw(ji,jj,jk) + e1e2t(ji,jj) / e3w_0(ji,jj,jk) * wmask(ji,jj,jk)   &
            ...
            CASE(  1  )                            ! 1st pass : eddy coef = ah_wslp2
               DO jk =  2,  jpkm1  ; DO jj = ntsj-(  iij-1), ntej+(  iij-1) ; DO ji = ntsi-( iij-1), ntei+(  iij-1)
                  ztfw(ji,jj,jk) =   &
                     ...
                     &           * ( pt(ji,jj,jk-1,jn) - pt(ji,jj,jk,jn) ) / e3w_0(ji,jj,jk) * wmask(ji,jj,jk)
               END DO   ;   END DO   ;   END DO
