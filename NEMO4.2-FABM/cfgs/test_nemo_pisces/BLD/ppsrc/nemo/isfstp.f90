...
CONTAINS
   ...
   SUBROUTINE isf_stp( kt, Kmm )
      ...
      IF ( ln_isfcav_mlt ) THEN
         ...
         CALL isf_tbl_lvl( ht_0(:,:),  e3t_0(:,:,:), misfkt_cav, misfkb_cav, rhisf_tbl_cav, rfrac_tbl_cav )
         !
      ...
      IF ( ln_isfpar_mlt ) THEN
         ...
         CALL isf_tbl_lvl( ht_0(:,:),  e3t_0(:,:,:), misfkt_par, misfkb_par, rhisf_tbl_par, rfrac_tbl_par )
         !
