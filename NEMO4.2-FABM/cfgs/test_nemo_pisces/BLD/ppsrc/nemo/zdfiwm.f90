...
CONTAINS
   ...
   SUBROUTINE zdf_iwm( kt, Kmm, p_avm, p_avt, p_avs )
      ...
      DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)                ! part independent of the level
         IF( ht_0(ji,jj) /= 0._wp ) THEN ; zfact(ji,jj) = ecri_iwm(ji,jj) * r1_rho0 / ( 1._wp - EXP( -ht_0(ji,jj) * hcri_iwm(ji,jj) ) )
      ...
      DO jk =  2,  jpkm1  ; DO jj = ntsj-(  nn_hls-1), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls-1), ntei+(  nn_hls-1)      ! complete with the level-dependent part
         zemx_iwm(ji,jj,jk) = zfact(ji,jj) * (  EXP( ( gdept_0(ji,jj,jk  ) - ht_0(ji,jj) ) * hcri_iwm(ji,jj) )   &
            &                                 - EXP( ( gdept_0(ji,jj,jk-1) - ht_0(ji,jj) ) * hcri_iwm(ji,jj) )   &
            &                                ) * wmask(ji,jj,jk) / e3w_0(ji,jj,jk)
      END DO   ;   END DO   ;   END DO

                               !* 'bot' component: distribute energy over the time-varying
                               !* ocean depth using an algebraic decay above the seafloor.
      DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)               ! part independent of the level
         IF( ht_0(ji,jj) /= 0._wp ) THEN ; zfact(ji,jj) = ebot_iwm(ji,jj) * ( 1._wp +  hbot_iwm(ji,jj) / ht_0(ji,jj)  ) * r1_rho0
         ELSE                          ; zfact(ji,jj) = 0._wp
         ENDIF
      END DO   ;   END DO
      ...
      DO jk =  2,  jpkm1  ; DO jj = ntsj-(  nn_hls-1), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls-1), ntei+(  nn_hls-1)     ! complete with the level-dependent part
         zemx_iwm(ji,jj,jk) = zemx_iwm(ji,jj,jk) +                                                                           & 
            &                 zfact(ji,jj) * (  1._wp / ( 1._wp + ( ht_0(ji,jj) - gdept_0(ji,jj,jk  ) ) / hbot_iwm(ji,jj) )  &
            &                                 - 1._wp / ( 1._wp + ( ht_0(ji,jj) - gdept_0(ji,jj,jk-1) ) / hbot_iwm(ji,jj) )  &
            &                                ) * wmask(ji,jj,jk) / e3w_0(ji,jj,jk)
      END DO   ;   END DO   ;   END DO
      ...
      DO jk =  2,  jpkm1  ; DO jj = ntsj-(  nn_hls-1), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls-1), ntei+(  nn_hls-1)     ! part independent of the level
         zfact(ji,jj) = zfact(ji,jj) + e3w_0(ji,jj,jk) * MAX( 0._wp, rn2(ji,jj,jk) )
      END DO   ;   END DO   ;   END DO
      !
      DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)
      ...
      END DO   ;   END DO
      DO jk =  2,  jpkm1  ; DO jj = ntsj-(  nn_hls-1), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls-1), ntei+(  nn_hls-1)     ! part independent of the level
         zfact(ji,jj) = zfact(ji,jj) + e3w_0(ji,jj,jk) * SQRT( MAX( 0._wp, rn2(ji,jj,jk) ) )
      END DO   ;   END DO   ;   END DO
      !
      DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)
      ...
      IF( iom_use("bflx_iwm") .OR. iom_use("pcmap_iwm") ) THEN
         ...
         DO jk =  2,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)
            ...
            z2d(ji,jj) = z2d(ji,jj) + rho0 * e3w_0(ji,jj,jk) * z3d(ji,jj,jk) * wmask(ji,jj,jk)
         END DO   ;   END DO   ;   END DO
      ...
      IF( kt == nit000 ) THEN        !* Control print at first time-step: diagnose the energy consumed by zav_wave
         ...
         DO jk =  2,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)
            zztmp = zztmp + e3w_0(ji,jj,jk) * e1e2t(ji,jj)   &
