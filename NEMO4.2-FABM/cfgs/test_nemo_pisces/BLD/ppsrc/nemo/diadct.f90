      ...
      IF(sec%nb_point .NE. 0)THEN   
         ...
         DO jseg=1,MAX(sec%nb_point-1,0)
            ...
            SELECT CASE( sec%direction(jseg) )
               ...
               zTnorm = zumid*e2u(k%I,k%J) * e3u_0(k%I,k%J,jk)     & 
                  &   + zvmid*e1v(k%I,k%J) * e3v_0(k%I,k%J,jk) 
...
!!gm end
  ...
  IF( ln_sco )THEN   ! s-coordinate case
     ...
     zdepu = ( gdept_0(ii1,ij1,kk) +  gdept_0(ii2,ij2,kk) ) * 0.5_wp 
     zdep1 = gdept_0(ii1,ij1,kk) - zdepu
     zdep2 = gdept_0(ii2,ij2,kk) - zdepu
  ...
  ELSE       ! full step or partial step case 
     ...
     ze3t  = e3t_0(ii2,ij2,kk) - e3t_0(ii1,ij1,kk) 
     zwgt1 = ( e3w_0(ii2,ij2,kk) - e3w_0(ii1,ij1,kk) )   &
        &    / e3w_0(ii2,ij2,kk)
     zwgt2 = ( e3w_0(ii1,ij1,kk) - e3w_0(ii2,ij2,kk) )   &
        &    / e3w_0(ii1,ij1,kk)
